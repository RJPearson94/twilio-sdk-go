...
type CreateMessageInteractionOutput struct {
	Sid                    string                  `json:"sid"`
...
func (c Client) Create(input *CreateMessageInteractionInput) (*CreateMessageInteractionOutput, error) {
...
func (c Client) CreateWithContext(context context.Context, input *CreateMessageInteractionInput) (*CreateMessageInteractionOutput, error) {
	...
	output := &CreateMessageInteractionOutput{}
