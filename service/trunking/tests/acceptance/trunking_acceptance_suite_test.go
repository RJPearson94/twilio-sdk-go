// +build acceptance trunking_acceptance
...
// 3) Twilio Phone Number SID set as an environment variable - TWILIO_PHONE_NUMBER_SID

func TestAcceptance(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Trunking Acceptance Test Suite")
}
