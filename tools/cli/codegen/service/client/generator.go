...
func init() {
	...
	parsedAPIClientReplacer := strings.NewReplacer("${addSubClientsToStruct}", addSubClientsToStruct, "${addSubClientsToClientInitialisation}", subAPIClientsFunctionReplacer.Replace(subAPIClientsReplacer.Replace(addSubClientsToClientInitialisation)))
